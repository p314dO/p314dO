...
**❤️ I love Offensive Security and technology** | **🧠 I’m currently working on ![AI Engineering things](https://github.com/aisecurityengineering/)**.
...
![Jupyter](https://img.shields.io/badge/Jupyter-F37626.svg?&style=flat-square&logo=Jupyter&logoColor=white) ![Claude](https://img.shields.io/badge/-Claude-000000?style=flat-square&logo=anthropic&logoColor=white)
...
## Security Projects
- 👨‍💻 **[Function JS](https://github.com/NicolasJoseGula/FunctionJS)** - Function enumerator for JS codebases, designed for Whitebox Pentesting and security-oriented code review.
- 📏 **[YARA Rules for PHP](https://github.com/NicolasJoseGula/YARA-rules-for-PHP)** - Yara rules for scan PHP Code.
- 🧪 **[VulnPrex](https://github.com/NicolasJoseGula/VulnpreX)** - A Vulnerable WordPress Lab Built with Docker.
- 🕵️‍♀️ **[Detection Engineering](https://github.com/NicolasJoseGula/Detection-Engineering)** - Stuff of Detection Engineering.
- 🔨 **[Offensive Security Tools](https://github.com/NicolasJoseGula/Offensive-Security-Tools)** - Tools used in the OSCP exam.
- 🐈‍⬛ **[Git Hunter](https://github.com/NicolasJoseGula/Git-Hunter)** - Scanner for detecting exposed Git repositories with enterprise-grade features
- 🪣 **[GCP Bucket Collector](https://github.com/NicolasJoseGula/GCP-Bucket-Collector)** - Enumerate and analyze Google Cloud Storage bucket contents without downloading files to disk.
- 🐞 **[My CVE's](https://github.com/NicolasJoseGula/CVEs)** - My CVE's

## Some of my cybersec certs
